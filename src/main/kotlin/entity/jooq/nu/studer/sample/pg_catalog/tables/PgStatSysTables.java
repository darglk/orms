...
public class PgStatSysTables extends TableImpl<Record> {
    ...
    private PgStatSysTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSysTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatSysTables(Table<O> child, ForeignKey<O, Record> key) {
