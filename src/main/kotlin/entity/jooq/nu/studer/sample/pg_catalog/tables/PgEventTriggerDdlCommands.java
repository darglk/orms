...
public class PgEventTriggerDdlCommands extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> COMMAND_TAG = createField(DSL.name("command_tag"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, Boolean> IN_EXTENSION = createField(DSL.name("in_extension"), SQLDataType.BOOLEAN, this, "");
     ...
     */
    @Deprecated
    public final TableField<Record, Object> COMMAND = createField(DSL.name("command"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_ddl_command\""), this, "");

    private PgEventTriggerDdlCommands(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgEventTriggerDdlCommands(Name alias, Table<Record> aliased, Field<?>[] parameters) {
