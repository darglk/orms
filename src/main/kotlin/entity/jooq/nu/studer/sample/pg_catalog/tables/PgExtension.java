...
public class PgExtension extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long[]> EXTCONFIG = createField(DSL.name("extconfig"), SQLDataType.BIGINT.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_extension.extcondition</code>.
     */
    public final TableField<Record, String[]> EXTCONDITION = createField(DSL.name("extcondition"), SQLDataType.CLOB.array(), this, "");
