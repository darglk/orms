...
public class PgStatSubscriptionStats extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> APPLY_ERROR_COUNT = createField(DSL.name("apply_error_count"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stat_subscription_stats.sync_error_count</code>.
     */
    public final TableField<Record, Long> SYNC_ERROR_COUNT = createField(DSL.name("sync_error_count"), SQLDataType.BIGINT, this, "");
    ...
    private PgStatSubscriptionStats(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSubscriptionStats(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatSubscriptionStats(Table<O> child, ForeignKey<O, Record> key) {
