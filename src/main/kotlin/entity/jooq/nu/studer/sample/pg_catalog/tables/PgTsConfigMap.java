...
public class PgTsConfigMap extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> MAPCFG = createField(DSL.name("mapcfg"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_ts_config_map.maptokentype</code>.
     */
    public final TableField<Record, Integer> MAPTOKENTYPE = createField(DSL.name("maptokentype"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_ts_config_map.mapseqno</code>.
     */
    public final TableField<Record, Integer> MAPSEQNO = createField(DSL.name("mapseqno"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_ts_config_map.mapdict</code>.
     */
    public final TableField<Record, Long> MAPDICT = createField(DSL.name("mapdict"), SQLDataType.BIGINT.nullable(false), this, "");

    private PgTsConfigMap(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgTsConfigMap(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgTsConfigMap(Table<O> child, ForeignKey<O, Record> key) {
