...
public class ForeignServers extends TableImpl<Record> {
    ...
    private ForeignServers(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private ForeignServers(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> ForeignServers(Table<O> child, ForeignKey<O, Record> key) {
