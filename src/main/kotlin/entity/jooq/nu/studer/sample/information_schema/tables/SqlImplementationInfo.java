...
public class SqlImplementationInfo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> IMPLEMENTATION_INFO_ID = createField(DSL.name("implementation_info_id"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.sql_implementation_info.implementation_info_name</code>.
     */
    public final TableField<Record, String> IMPLEMENTATION_INFO_NAME = createField(DSL.name("implementation_info_name"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.sql_implementation_info.integer_value</code>.
     */
    public final TableField<Record, Integer> INTEGER_VALUE = createField(DSL.name("integer_value"), nu.studer.sample.information_schema.Domains.CARDINAL_NUMBER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.sql_implementation_info.character_value</code>.
     */
    public final TableField<Record, String> CHARACTER_VALUE = createField(DSL.name("character_value"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
