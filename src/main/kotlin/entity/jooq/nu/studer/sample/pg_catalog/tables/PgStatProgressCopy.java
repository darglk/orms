...
public class PgStatProgressCopy extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> BYTES_PROCESSED = createField(DSL.name("bytes_processed"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_progress_copy.bytes_total</code>.
     */
    public final TableField<Record, Long> BYTES_TOTAL = createField(DSL.name("bytes_total"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stat_progress_copy.tuples_processed</code>.
     */
    public final TableField<Record, Long> TUPLES_PROCESSED = createField(DSL.name("tuples_processed"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_progress_copy.tuples_excluded</code>.
     */
    public final TableField<Record, Long> TUPLES_EXCLUDED = createField(DSL.name("tuples_excluded"), SQLDataType.BIGINT, this, "");

    private PgStatProgressCopy(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatProgressCopy(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatProgressCopy(Table<O> child, ForeignKey<O, Record> key) {
