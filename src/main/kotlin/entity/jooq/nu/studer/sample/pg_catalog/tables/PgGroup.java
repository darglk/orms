...
public class PgGroup extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> GRONAME = createField(DSL.name("groname"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_group.grosysid</code>.
     */
    public final TableField<Record, Long> GROSYSID = createField(DSL.name("grosysid"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_group.grolist</code>.
     */
    public final TableField<Record, Long[]> GROLIST = createField(DSL.name("grolist"), SQLDataType.BIGINT.array(), this, "");

    private PgGroup(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgGroup(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgGroup(Table<O> child, ForeignKey<O, Record> key) {
