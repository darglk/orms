...
public class PgAuthMembers extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> ROLEID = createField(DSL.name("roleid"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_auth_members.member</code>.
     */
    public final TableField<Record, Long> MEMBER = createField(DSL.name("member"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_auth_members.grantor</code>.
     */
    public final TableField<Record, Long> GRANTOR = createField(DSL.name("grantor"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_auth_members.admin_option</code>.
     */
    public final TableField<Record, Boolean> ADMIN_OPTION = createField(DSL.name("admin_option"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_auth_members.inherit_option</code>.
     */
    public final TableField<Record, Boolean> INHERIT_OPTION = createField(DSL.name("inherit_option"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_auth_members.set_option</code>.
     */
    public final TableField<Record, Boolean> SET_OPTION = createField(DSL.name("set_option"), SQLDataType.BOOLEAN.nullable(false), this, "");

    private PgAuthMembers(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgAuthMembers(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgAuthMembers(Table<O> child, ForeignKey<O, Record> key) {
