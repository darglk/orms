...
public class PgStatActivity extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> QUERY_ID = createField(DSL.name("query_id"), SQLDataType.BIGINT, this, "");
    ...
    private PgStatActivity(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatActivity(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatActivity(Table<O> child, ForeignKey<O, Record> key) {
