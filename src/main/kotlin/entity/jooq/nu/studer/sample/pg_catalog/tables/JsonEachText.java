...
public class JsonEachText extends TableImpl<Record> {
    ...
    private JsonEachText(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR)
        });
    }

    private JsonEachText(Name alias, Table<Record> aliased, Field<?>[] parameters) {
