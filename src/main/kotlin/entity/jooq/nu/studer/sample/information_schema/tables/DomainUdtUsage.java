...
public class DomainUdtUsage extends TableImpl<Record> {
    ...
    private DomainUdtUsage(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private DomainUdtUsage(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> DomainUdtUsage(Table<O> child, ForeignKey<O, Record> key) {
