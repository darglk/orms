...
public class PgIndexes extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> INDEXNAME = createField(DSL.name("indexname"), SQLDataType.VARCHAR, this, "");
     ...
     */
    public final TableField<Record, String> INDEXDEF = createField(DSL.name("indexdef"), SQLDataType.CLOB, this, "");

    private PgIndexes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgIndexes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgIndexes(Table<O> child, ForeignKey<O, Record> key) {
