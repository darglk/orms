...
public class PgOpfamily extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> OPFMETHOD = createField(DSL.name("opfmethod"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_opfamily.opfname</code>.
     */
    public final TableField<Record, String> OPFNAME = createField(DSL.name("opfname"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_opfamily.opfnamespace</code>.
     */
    public final TableField<Record, Long> OPFNAMESPACE = createField(DSL.name("opfnamespace"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_opfamily.opfowner</code>.
     */
    public final TableField<Record, Long> OPFOWNER = createField(DSL.name("opfowner"), SQLDataType.BIGINT.nullable(false), this, "");

    private PgOpfamily(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgOpfamily(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgOpfamily(Table<O> child, ForeignKey<O, Record> key) {
