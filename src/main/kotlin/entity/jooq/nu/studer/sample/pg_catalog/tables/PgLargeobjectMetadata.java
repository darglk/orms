...
public class PgLargeobjectMetadata extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> LOMOWNER = createField(DSL.name("lomowner"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_largeobject_metadata.lomacl</code>.
     */
    public final TableField<Record, String[]> LOMACL = createField(DSL.name("lomacl"), SQLDataType.VARCHAR.array(), this, "");

    private PgLargeobjectMetadata(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgLargeobjectMetadata(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgLargeobjectMetadata(Table<O> child, ForeignKey<O, Record> key) {
