...
public class PgStatsExtExprs extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> STATISTICS_SCHEMANAME = createField(DSL.name("statistics_schemaname"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.statistics_name</code>.
     */
    public final TableField<Record, String> STATISTICS_NAME = createField(DSL.name("statistics_name"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.statistics_owner</code>.
     */
    public final TableField<Record, String> STATISTICS_OWNER = createField(DSL.name("statistics_owner"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.expr</code>.
     */
    public final TableField<Record, String> EXPR = createField(DSL.name("expr"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.inherited</code>.
     */
    public final TableField<Record, Boolean> INHERITED = createField(DSL.name("inherited"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.null_frac</code>.
     */
    public final TableField<Record, Float> NULL_FRAC = createField(DSL.name("null_frac"), SQLDataType.REAL, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.avg_width</code>.
     */
    public final TableField<Record, Integer> AVG_WIDTH = createField(DSL.name("avg_width"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.n_distinct</code>.
     */
    public final TableField<Record, Float> N_DISTINCT = createField(DSL.name("n_distinct"), SQLDataType.REAL, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.most_common_vals</code>.
     */
    public final TableField<Record, Object[]> MOST_COMMON_VALS = createField(DSL.name("most_common_vals"), SQLDataType.OTHER.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.most_common_freqs</code>.
     */
    public final TableField<Record, Float[]> MOST_COMMON_FREQS = createField(DSL.name("most_common_freqs"), SQLDataType.REAL.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.histogram_bounds</code>.
     */
    public final TableField<Record, Object[]> HISTOGRAM_BOUNDS = createField(DSL.name("histogram_bounds"), SQLDataType.OTHER.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.correlation</code>.
     */
    public final TableField<Record, Float> CORRELATION = createField(DSL.name("correlation"), SQLDataType.REAL, this, "");

    /**
     * The column <code>pg_catalog.pg_stats_ext_exprs.most_common_elems</code>.
     */
    public final TableField<Record, Object[]> MOST_COMMON_ELEMS = createField(DSL.name("most_common_elems"), SQLDataType.OTHER.array(), this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stats_ext_exprs.most_common_elem_freqs</code>.
     */
    public final TableField<Record, Float[]> MOST_COMMON_ELEM_FREQS = createField(DSL.name("most_common_elem_freqs"), SQLDataType.REAL.array(), this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stats_ext_exprs.elem_count_histogram</code>.
     */
    public final TableField<Record, Float[]> ELEM_COUNT_HISTOGRAM = createField(DSL.name("elem_count_histogram"), SQLDataType.REAL.array(), this, "");

    private PgStatsExtExprs(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatsExtExprs(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatsExtExprs(Table<O> child, ForeignKey<O, Record> key) {
