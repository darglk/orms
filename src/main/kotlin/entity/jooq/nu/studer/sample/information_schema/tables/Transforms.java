...
public class Transforms extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> GROUP_NAME = createField(DSL.name("group_name"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.transforms.transform_type</code>.
     */
    public final TableField<Record, String> TRANSFORM_TYPE = createField(DSL.name("transform_type"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    private Transforms(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private Transforms(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Transforms(Table<O> child, ForeignKey<O, Record> key) {
