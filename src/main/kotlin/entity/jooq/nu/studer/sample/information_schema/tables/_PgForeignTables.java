...
public class _PgForeignTables extends TableImpl<Record> {
    ...
    private _PgForeignTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private _PgForeignTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> _PgForeignTables(Table<O> child, ForeignKey<O, Record> key) {
