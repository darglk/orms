...
public class ColumnOptions extends TableImpl<Record> {
    ...
    private ColumnOptions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private ColumnOptions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> ColumnOptions(Table<O> child, ForeignKey<O, Record> key) {
