...
public class JsonbArrayElementsText extends TableImpl<Record> {
    ...
    private JsonbArrayElementsText(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR)
        });
    }

    private JsonbArrayElementsText(Name alias, Table<Record> aliased, Field<?>[] parameters) {
