...
public class PgSeclabels extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> OBJOID = createField(DSL.name("objoid"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_seclabels.classoid</code>.
     */
    public final TableField<Record, Long> CLASSOID = createField(DSL.name("classoid"), SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<Record, String> OBJTYPE = createField(DSL.name("objtype"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_seclabels.objnamespace</code>.
     */
    public final TableField<Record, Long> OBJNAMESPACE = createField(DSL.name("objnamespace"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_seclabels.objname</code>.
     */
    public final TableField<Record, String> OBJNAME = createField(DSL.name("objname"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_seclabels.provider</code>.
     */
    public final TableField<Record, String> PROVIDER = createField(DSL.name("provider"), SQLDataType.CLOB, this, "");
    ...
    private PgSeclabels(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgSeclabels(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgSeclabels(Table<O> child, ForeignKey<O, Record> key) {
