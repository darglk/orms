...
public class PgLsArchiveStatusdir extends TableImpl<Record> {
    ...
    private PgLsArchiveStatusdir(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgLsArchiveStatusdir(Name alias, Table<Record> aliased, Field<?>[] parameters) {
