...
public class PgTrigger extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Object[]> TGATTR = createField(DSL.name("tgattr"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").nullable(false).array(), this, "");
