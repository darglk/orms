...
public class JsonbToRecordset extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Record> JSONB_TO_RECORDSET_ = createField(DSL.name("jsonb_to_recordset"), SQLDataType.RECORD, this, "");

    private JsonbToRecordset(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR)
        });
    }

    private JsonbToRecordset(Name alias, Table<Record> aliased, Field<?>[] parameters) {
