...
public class PgStatGetSubscription extends TableImpl<Record> {
    ...
    private PgStatGetSubscription(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.BIGINT)
        });
    }

    private PgStatGetSubscription(Name alias, Table<Record> aliased, Field<?>[] parameters) {
