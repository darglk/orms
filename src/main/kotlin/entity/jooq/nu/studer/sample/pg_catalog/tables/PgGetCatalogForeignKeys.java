...
public class PgGetCatalogForeignKeys extends TableImpl<Record> {
     ...
     */
    @Deprecated
    public final TableField<Record, Object> FKTABLE = createField(DSL.name("fktable"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\""), this, "");

    /**
     * The column <code>pg_catalog.pg_get_catalog_foreign_keys.fkcols</code>.
     */
    public final TableField<Record, String[]> FKCOLS = createField(DSL.name("fkcols"), SQLDataType.CLOB.array(), this, "");
     ...
     */
    @Deprecated
    public final TableField<Record, Object> PKTABLE = createField(DSL.name("pktable"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\""), this, "");

    /**
     * The column <code>pg_catalog.pg_get_catalog_foreign_keys.pkcols</code>.
     */
    public final TableField<Record, String[]> PKCOLS = createField(DSL.name("pkcols"), SQLDataType.CLOB.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_get_catalog_foreign_keys.is_array</code>.
     */
    public final TableField<Record, Boolean> IS_ARRAY = createField(DSL.name("is_array"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>pg_catalog.pg_get_catalog_foreign_keys.is_opt</code>.
     */
    public final TableField<Record, Boolean> IS_OPT = createField(DSL.name("is_opt"), SQLDataType.BOOLEAN, this, "");

    private PgGetCatalogForeignKeys(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgGetCatalogForeignKeys(Name alias, Table<Record> aliased, Field<?>[] parameters) {
