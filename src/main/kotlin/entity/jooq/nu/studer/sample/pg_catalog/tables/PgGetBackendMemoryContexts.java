...
public class PgGetBackendMemoryContexts extends TableImpl<Record> {
    ...
    private PgGetBackendMemoryContexts(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgGetBackendMemoryContexts(Name alias, Table<Record> aliased, Field<?>[] parameters) {
