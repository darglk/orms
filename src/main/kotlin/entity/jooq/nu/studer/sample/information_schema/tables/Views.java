...
public class Views extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> VIEW_DEFINITION = createField(DSL.name("view_definition"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column <code>information_schema.views.check_option</code>.
     */
    public final TableField<Record, String> CHECK_OPTION = createField(DSL.name("check_option"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
     ...
     */
    public final TableField<Record, String> IS_TRIGGER_UPDATABLE = createField(DSL.name("is_trigger_updatable"), nu.studer.sample.information_schema.Domains.YES_OR_NO.getDataType(), this, "");

    /**
     * The column <code>information_schema.views.is_trigger_deletable</code>.
     */
    public final TableField<Record, String> IS_TRIGGER_DELETABLE = createField(DSL.name("is_trigger_deletable"), nu.studer.sample.information_schema.Domains.YES_OR_NO.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.views.is_trigger_insertable_into</code>.
     */
    public final TableField<Record, String> IS_TRIGGER_INSERTABLE_INTO = createField(DSL.name("is_trigger_insertable_into"), nu.studer.sample.information_schema.Domains.YES_OR_NO.getDataType(), this, "");
