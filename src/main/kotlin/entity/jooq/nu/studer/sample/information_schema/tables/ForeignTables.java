...
public class ForeignTables extends TableImpl<Record> {
    ...
    private ForeignTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private ForeignTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> ForeignTables(Table<O> child, ForeignKey<O, Record> key) {
