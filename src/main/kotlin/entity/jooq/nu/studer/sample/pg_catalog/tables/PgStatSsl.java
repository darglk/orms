...
public class PgStatSsl extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> CIPHER = createField(DSL.name("cipher"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_ssl.bits</code>.
     */
    public final TableField<Record, Integer> BITS = createField(DSL.name("bits"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_ssl.client_dn</code>.
     */
    public final TableField<Record, String> CLIENT_DN = createField(DSL.name("client_dn"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_ssl.client_serial</code>.
     */
    public final TableField<Record, BigDecimal> CLIENT_SERIAL = createField(DSL.name("client_serial"), SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_ssl.issuer_dn</code>.
     */
    public final TableField<Record, String> ISSUER_DN = createField(DSL.name("issuer_dn"), SQLDataType.CLOB, this, "");

    private PgStatSsl(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSsl(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatSsl(Table<O> child, ForeignKey<O, Record> key) {
