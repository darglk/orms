...
public class PgStatioUserTables extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> HEAP_BLKS_READ = createField(DSL.name("heap_blks_read"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_user_tables.heap_blks_hit</code>.
     */
    public final TableField<Record, Long> HEAP_BLKS_HIT = createField(DSL.name("heap_blks_hit"), SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<Record, Long> TOAST_BLKS_READ = createField(DSL.name("toast_blks_read"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_user_tables.toast_blks_hit</code>.
     */
    public final TableField<Record, Long> TOAST_BLKS_HIT = createField(DSL.name("toast_blks_hit"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_user_tables.tidx_blks_read</code>.
     */
    public final TableField<Record, Long> TIDX_BLKS_READ = createField(DSL.name("tidx_blks_read"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_user_tables.tidx_blks_hit</code>.
     */
    public final TableField<Record, Long> TIDX_BLKS_HIT = createField(DSL.name("tidx_blks_hit"), SQLDataType.BIGINT, this, "");

    private PgStatioUserTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatioUserTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatioUserTables(Table<O> child, ForeignKey<O, Record> key) {
