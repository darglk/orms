...
public class PgPreparedXacts extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> OWNER = createField(DSL.name("owner"), SQLDataType.VARCHAR, this, "");
    ...
    private PgPreparedXacts(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgPreparedXacts(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgPreparedXacts(Table<O> child, ForeignKey<O, Record> key) {
