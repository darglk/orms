...
public class ElementTypes extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> OBJECT_CATALOG = createField(DSL.name("object_catalog"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.element_types.object_schema</code>.
     */
    public final TableField<Record, String> OBJECT_SCHEMA = createField(DSL.name("object_schema"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.element_types.object_name</code>.
     */
    public final TableField<Record, String> OBJECT_NAME = createField(DSL.name("object_name"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.element_types.object_type</code>.
     */
    public final TableField<Record, String> OBJECT_TYPE = createField(DSL.name("object_type"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.element_types.collection_type_identifier</code>.
     */
    public final TableField<Record, String> COLLECTION_TYPE_IDENTIFIER = createField(DSL.name("collection_type_identifier"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
     ...
     */
    public final TableField<Record, String> DOMAIN_DEFAULT = createField(DSL.name("domain_default"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
