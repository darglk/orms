...
public class PgStatSysIndexes extends TableImpl<Record> {
    ...
    private PgStatSysIndexes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSysIndexes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatSysIndexes(Table<O> child, ForeignKey<O, Record> key) {
