...
public class PgHbaFileRules extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> RULE_NUMBER = createField(DSL.name("rule_number"), SQLDataType.INTEGER, this, "");
     ...
     */
    public final TableField<Record, String[]> DATABASE = createField(DSL.name("database"), SQLDataType.CLOB.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_hba_file_rules.user_name</code>.
     */
    public final TableField<Record, String[]> USER_NAME = createField(DSL.name("user_name"), SQLDataType.CLOB.array(), this, "");
     ...
     */
    public final TableField<Record, String[]> OPTIONS = createField(DSL.name("options"), SQLDataType.CLOB.array(), this, "");
