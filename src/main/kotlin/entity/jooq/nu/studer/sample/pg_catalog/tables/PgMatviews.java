...
public class PgMatviews extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> MATVIEWNAME = createField(DSL.name("matviewname"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_matviews.matviewowner</code>.
     */
    public final TableField<Record, String> MATVIEWOWNER = createField(DSL.name("matviewowner"), SQLDataType.VARCHAR, this, "");
     ...
     */
    public final TableField<Record, Boolean> ISPOPULATED = createField(DSL.name("ispopulated"), SQLDataType.BOOLEAN, this, "");
    ...
    private PgMatviews(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgMatviews(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgMatviews(Table<O> child, ForeignKey<O, Record> key) {
