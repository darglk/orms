...
public class ForeignDataWrapperOptions extends TableImpl<Record> {
    ...
    private ForeignDataWrapperOptions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private ForeignDataWrapperOptions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> ForeignDataWrapperOptions(Table<O> child, ForeignKey<O, Record> key) {
