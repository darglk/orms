...
public class PgViews extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> VIEWNAME = createField(DSL.name("viewname"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_views.viewowner</code>.
     */
    public final TableField<Record, String> VIEWOWNER = createField(DSL.name("viewowner"), SQLDataType.VARCHAR, this, "");
    ...
    private PgViews(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgViews(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgViews(Table<O> child, ForeignKey<O, Record> key) {
