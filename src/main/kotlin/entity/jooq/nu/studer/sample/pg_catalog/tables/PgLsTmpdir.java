...
public class PgLsTmpdir extends TableImpl<Record> {
    ...
    private PgLsTmpdir(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgLsTmpdir(Name alias, Table<Record> aliased, Field<?>[] parameters) {
