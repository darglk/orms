...
public class PgStatUserFunctions extends TableImpl<Record> {
    ...
    private PgStatUserFunctions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatUserFunctions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatUserFunctions(Table<O> child, ForeignKey<O, Record> key) {
