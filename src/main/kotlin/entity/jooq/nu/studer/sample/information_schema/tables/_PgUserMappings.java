...
public class _PgUserMappings extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SRVOWNER = createField(DSL.name("srvowner"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    private _PgUserMappings(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private _PgUserMappings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> _PgUserMappings(Table<O> child, ForeignKey<O, Record> key) {
