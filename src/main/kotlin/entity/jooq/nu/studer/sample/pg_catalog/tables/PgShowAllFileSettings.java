...
public class PgShowAllFileSettings extends TableImpl<Record> {
    ...
    private PgShowAllFileSettings(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgShowAllFileSettings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
