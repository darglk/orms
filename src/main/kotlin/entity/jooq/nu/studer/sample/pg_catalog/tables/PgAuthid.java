...
public class PgAuthid extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> ROLNAME = createField(DSL.name("rolname"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolsuper</code>.
     */
    public final TableField<Record, Boolean> ROLSUPER = createField(DSL.name("rolsuper"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolinherit</code>.
     */
    public final TableField<Record, Boolean> ROLINHERIT = createField(DSL.name("rolinherit"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolcreaterole</code>.
     */
    public final TableField<Record, Boolean> ROLCREATEROLE = createField(DSL.name("rolcreaterole"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolcreatedb</code>.
     */
    public final TableField<Record, Boolean> ROLCREATEDB = createField(DSL.name("rolcreatedb"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolcanlogin</code>.
     */
    public final TableField<Record, Boolean> ROLCANLOGIN = createField(DSL.name("rolcanlogin"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolreplication</code>.
     */
    public final TableField<Record, Boolean> ROLREPLICATION = createField(DSL.name("rolreplication"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolbypassrls</code>.
     */
    public final TableField<Record, Boolean> ROLBYPASSRLS = createField(DSL.name("rolbypassrls"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_authid.rolconnlimit</code>.
     */
    public final TableField<Record, Integer> ROLCONNLIMIT = createField(DSL.name("rolconnlimit"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    private PgAuthid(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgAuthid(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgAuthid(Table<O> child, ForeignKey<O, Record> key) {
