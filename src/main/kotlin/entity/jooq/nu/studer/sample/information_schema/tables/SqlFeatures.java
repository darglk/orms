...
public class SqlFeatures extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SUB_FEATURE_ID = createField(DSL.name("sub_feature_id"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column <code>information_schema.sql_features.sub_feature_name</code>.
     */
    public final TableField<Record, String> SUB_FEATURE_NAME = createField(DSL.name("sub_feature_name"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
