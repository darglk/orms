...
public class PgStatGssapi extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Boolean> GSS_AUTHENTICATED = createField(DSL.name("gss_authenticated"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_gssapi.principal</code>.
     */
    public final TableField<Record, String> PRINCIPAL = createField(DSL.name("principal"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_gssapi.encrypted</code>.
     */
    public final TableField<Record, Boolean> ENCRYPTED = createField(DSL.name("encrypted"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_gssapi.credentials_delegated</code>.
     */
    public final TableField<Record, Boolean> CREDENTIALS_DELEGATED = createField(DSL.name("credentials_delegated"), SQLDataType.BOOLEAN, this, "");

    private PgStatGssapi(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatGssapi(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatGssapi(Table<O> child, ForeignKey<O, Record> key) {
