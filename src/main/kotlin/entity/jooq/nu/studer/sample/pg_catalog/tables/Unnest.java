...
public class Unnest extends TableImpl<Record> {
     ...
     */
    @Deprecated
    public final TableField<Record, Object> UNNEST_ = createField(DSL.name("unnest"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"anyrange\""), this, "");

    private Unnest(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anymultirange\""))
        });
    }

    private Unnest(Name alias, Table<Record> aliased, Field<?>[] parameters) {
