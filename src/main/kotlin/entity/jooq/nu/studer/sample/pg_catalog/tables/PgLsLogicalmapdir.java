...
public class PgLsLogicalmapdir extends TableImpl<Record> {
    ...
    private PgLsLogicalmapdir(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgLsLogicalmapdir(Name alias, Table<Record> aliased, Field<?>[] parameters) {
