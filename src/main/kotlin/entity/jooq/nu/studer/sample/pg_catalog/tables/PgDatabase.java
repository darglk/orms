...
public class PgDatabase extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> DATLOCPROVIDER = createField(DSL.name("datlocprovider"), SQLDataType.CHAR.nullable(false), this, "");
     ...
     */
    public final TableField<Record, String> DATCOLLATE = createField(DSL.name("datcollate"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_database.datctype</code>.
     */
    public final TableField<Record, String> DATCTYPE = createField(DSL.name("datctype"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_database.daticulocale</code>.
     */
    public final TableField<Record, String> DATICULOCALE = createField(DSL.name("daticulocale"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_database.daticurules</code>.
     */
    public final TableField<Record, String> DATICURULES = createField(DSL.name("daticurules"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_database.datcollversion</code>.
     */
    public final TableField<Record, String> DATCOLLVERSION = createField(DSL.name("datcollversion"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_database.datacl</code>.
     */
    public final TableField<Record, String[]> DATACL = createField(DSL.name("datacl"), SQLDataType.VARCHAR.array(), this, "");
