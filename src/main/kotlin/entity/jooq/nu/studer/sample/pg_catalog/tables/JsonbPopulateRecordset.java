...
public class JsonbPopulateRecordset extends TableImpl<Record> {
     ...
     */
    @Deprecated
    public final TableField<Record, Object> JSONB_POPULATE_RECORDSET_ = createField(DSL.name("jsonb_populate_recordset"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"anyelement\""), this, "");

    private JsonbPopulateRecordset(Name alias, Table<Record> aliased) {
    ...
    private JsonbPopulateRecordset(Name alias, Table<Record> aliased, Field<?>[] parameters) {
