...
public class UserMappingOptions extends TableImpl<Record> {
    ...
    private UserMappingOptions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private UserMappingOptions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> UserMappingOptions(Table<O> child, ForeignKey<O, Record> key) {
