...
public class PgStatWal extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> WAL_BUFFERS_FULL = createField(DSL.name("wal_buffers_full"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_wal.wal_write</code>.
     */
    public final TableField<Record, Long> WAL_WRITE = createField(DSL.name("wal_write"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_wal.wal_sync</code>.
     */
    public final TableField<Record, Long> WAL_SYNC = createField(DSL.name("wal_sync"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_wal.wal_write_time</code>.
     */
    public final TableField<Record, Double> WAL_WRITE_TIME = createField(DSL.name("wal_write_time"), SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_wal.wal_sync_time</code>.
     */
    public final TableField<Record, Double> WAL_SYNC_TIME = createField(DSL.name("wal_sync_time"), SQLDataType.DOUBLE, this, "");
    ...
    private PgStatWal(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatWal(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatWal(Table<O> child, ForeignKey<O, Record> key) {
