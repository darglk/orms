...
public class Parameters extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> PARAMETER_MODE = createField(DSL.name("parameter_mode"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column <code>information_schema.parameters.is_result</code>.
     */
    public final TableField<Record, String> IS_RESULT = createField(DSL.name("is_result"), nu.studer.sample.information_schema.Domains.YES_OR_NO.getDataType(), this, "");
     ...
     */
    public final TableField<Record, String> PARAMETER_NAME = createField(DSL.name("parameter_name"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
     ...
     */
    public final TableField<Record, String> PARAMETER_DEFAULT = createField(DSL.name("parameter_default"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
