...
public class _PgForeignTableColumns extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> NSPNAME = createField(DSL.name("nspname"), SQLDataType.VARCHAR, this, "");
    ...
    private _PgForeignTableColumns(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private _PgForeignTableColumns(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> _PgForeignTableColumns(Table<O> child, ForeignKey<O, Record> key) {
