...
public class PgStatDatabaseConflicts extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> CONFL_TABLESPACE = createField(DSL.name("confl_tablespace"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_database_conflicts.confl_lock</code>.
     */
    public final TableField<Record, Long> CONFL_LOCK = createField(DSL.name("confl_lock"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stat_database_conflicts.confl_snapshot</code>.
     */
    public final TableField<Record, Long> CONFL_SNAPSHOT = createField(DSL.name("confl_snapshot"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stat_database_conflicts.confl_bufferpin</code>.
     */
    public final TableField<Record, Long> CONFL_BUFFERPIN = createField(DSL.name("confl_bufferpin"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stat_database_conflicts.confl_deadlock</code>.
     */
    public final TableField<Record, Long> CONFL_DEADLOCK = createField(DSL.name("confl_deadlock"), SQLDataType.BIGINT, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stat_database_conflicts.confl_active_logicalslot</code>.
     */
    public final TableField<Record, Long> CONFL_ACTIVE_LOGICALSLOT = createField(DSL.name("confl_active_logicalslot"), SQLDataType.BIGINT, this, "");

    private PgStatDatabaseConflicts(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatDatabaseConflicts(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatDatabaseConflicts(Table<O> child, ForeignKey<O, Record> key) {
