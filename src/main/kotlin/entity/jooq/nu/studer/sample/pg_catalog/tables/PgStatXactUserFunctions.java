...
public class PgStatXactUserFunctions extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> FUNCID = createField(DSL.name("funcid"), SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<Record, String> FUNCNAME = createField(DSL.name("funcname"), SQLDataType.VARCHAR, this, "");
     ...
     */
    public final TableField<Record, Double> TOTAL_TIME = createField(DSL.name("total_time"), SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_functions.self_time</code>.
     */
    public final TableField<Record, Double> SELF_TIME = createField(DSL.name("self_time"), SQLDataType.DOUBLE, this, "");

    private PgStatXactUserFunctions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatXactUserFunctions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatXactUserFunctions(Table<O> child, ForeignKey<O, Record> key) {
