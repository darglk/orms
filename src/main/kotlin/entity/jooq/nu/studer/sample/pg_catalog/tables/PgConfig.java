...
public class PgConfig extends TableImpl<Record> {
    ...
    private PgConfig(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgConfig(Name alias, Table<Record> aliased, Field<?>[] parameters) {
