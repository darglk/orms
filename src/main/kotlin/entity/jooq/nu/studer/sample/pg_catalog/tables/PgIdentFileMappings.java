...
public class PgIdentFileMappings extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> MAP_NUMBER = createField(DSL.name("map_number"), SQLDataType.INTEGER, this, "");
     ...
     */
    public final TableField<Record, String> MAP_NAME = createField(DSL.name("map_name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_ident_file_mappings.sys_name</code>.
     */
    public final TableField<Record, String> SYS_NAME = createField(DSL.name("sys_name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_ident_file_mappings.pg_username</code>.
     */
    public final TableField<Record, String> PG_USERNAME = createField(DSL.name("pg_username"), SQLDataType.CLOB, this, "");
    ...
    private PgIdentFileMappings(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgIdentFileMappings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
