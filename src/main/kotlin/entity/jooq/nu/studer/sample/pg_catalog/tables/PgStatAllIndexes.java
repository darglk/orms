...
public class PgStatAllIndexes extends TableImpl<Record> {
    ...
    private PgStatAllIndexes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatAllIndexes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatAllIndexes(Table<O> child, ForeignKey<O, Record> key) {
