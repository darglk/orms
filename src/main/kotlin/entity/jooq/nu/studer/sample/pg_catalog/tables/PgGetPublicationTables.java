...
public class PgGetPublicationTables extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> PUBID = createField(DSL.name("pubid"), SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<Record, Object[]> ATTRS = createField(DSL.name("attrs"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").array(), this, "");
     ...
     */
    @Deprecated
    public final TableField<Record, Object> QUAL = createField(DSL.name("qual"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_node_tree\""), this, "");

    private PgGetPublicationTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.CLOB.array())
        });
    }

    private PgGetPublicationTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
