...
public class PgFileSettings extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> SEQNO = createField(DSL.name("seqno"), SQLDataType.INTEGER, this, "");
     ...
     */
    public final TableField<Record, Boolean> APPLIED = createField(DSL.name("applied"), SQLDataType.BOOLEAN, this, "");
    ...
    private PgFileSettings(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgFileSettings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgFileSettings(Table<O> child, ForeignKey<O, Record> key) {
