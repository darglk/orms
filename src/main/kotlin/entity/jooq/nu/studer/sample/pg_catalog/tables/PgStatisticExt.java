...
public class PgStatisticExt extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Object[]> STXKEYS = createField(DSL.name("stxkeys"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").nullable(false).array(), this, "");

    /**
     * The column <code>pg_catalog.pg_statistic_ext.stxkind</code>.
     */
    public final TableField<Record, String[]> STXKIND = createField(DSL.name("stxkind"), SQLDataType.CHAR.nullable(false).array(), this, "");
     ...
     */
    @Deprecated
    public final TableField<Record, Object> STXEXPRS = createField(DSL.name("stxexprs"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_node_tree\""), this, "");
