...
public class PgStatioAllIndexes extends TableImpl<Record> {
    ...
    private PgStatioAllIndexes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatioAllIndexes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatioAllIndexes(Table<O> child, ForeignKey<O, Record> key) {
