...
public class PgTablespaceDatabases extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> PG_TABLESPACE_DATABASES_ = createField(DSL.name("pg_tablespace_databases"), SQLDataType.BIGINT, this, "");

    private PgTablespaceDatabases(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.BIGINT)
        });
    }

    private PgTablespaceDatabases(Name alias, Table<Record> aliased, Field<?>[] parameters) {
