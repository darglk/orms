...
public class PgRules extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> RULENAME = createField(DSL.name("rulename"), SQLDataType.VARCHAR, this, "");
    ...
    private PgRules(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgRules(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgRules(Table<O> child, ForeignKey<O, Record> key) {
