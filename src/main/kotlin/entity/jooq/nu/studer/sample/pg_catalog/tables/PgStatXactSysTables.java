...
public class PgStatXactSysTables extends TableImpl<Record> {
    ...
    private PgStatXactSysTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatXactSysTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatXactSysTables(Table<O> child, ForeignKey<O, Record> key) {
