...
public class PgMcvListItems extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> INDEX = createField(DSL.name("index"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>pg_catalog.pg_mcv_list_items.values</code>.
     */
    public final TableField<Record, String[]> VALUES = createField(DSL.name("values"), SQLDataType.CLOB.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_mcv_list_items.nulls</code>.
     */
    public final TableField<Record, Boolean[]> NULLS = createField(DSL.name("nulls"), SQLDataType.BOOLEAN.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_mcv_list_items.frequency</code>.
     */
    public final TableField<Record, Double> FREQUENCY = createField(DSL.name("frequency"), SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>pg_catalog.pg_mcv_list_items.base_frequency</code>.
     */
    public final TableField<Record, Double> BASE_FREQUENCY = createField(DSL.name("base_frequency"), SQLDataType.DOUBLE, this, "");

    private PgMcvListItems(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_mcv_list\""))
        });
    }

    private PgMcvListItems(Name alias, Table<Record> aliased, Field<?>[] parameters) {
