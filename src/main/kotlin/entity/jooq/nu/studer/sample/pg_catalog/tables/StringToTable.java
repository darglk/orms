...
public class StringToTable extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> STRING_TO_TABLE_ = createField(DSL.name("string_to_table"), SQLDataType.CLOB, this, "");

    private StringToTable(Name alias, Table<Record> aliased) {
    ...
    private StringToTable(Name alias, Table<Record> aliased, Field<?>[] parameters) {
