...
public class PgStats extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> ATTNAME = createField(DSL.name("attname"), SQLDataType.VARCHAR, this, "");
    ...
    private PgStats(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStats(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStats(Table<O> child, ForeignKey<O, Record> key) {
