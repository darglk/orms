...
public class PgLsLogdir extends TableImpl<Record> {
    ...
    private PgLsLogdir(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgLsLogdir(Name alias, Table<Record> aliased, Field<?>[] parameters) {
