...
public class PgStatGetRecoveryPrefetch extends TableImpl<Record> {
    ...
    private PgStatGetRecoveryPrefetch(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgStatGetRecoveryPrefetch(Name alias, Table<Record> aliased, Field<?>[] parameters) {
