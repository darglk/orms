...
public class PgStatioSysTables extends TableImpl<Record> {
    ...
    private PgStatioSysTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatioSysTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatioSysTables(Table<O> child, ForeignKey<O, Record> key) {
