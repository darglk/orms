...
public class ForeignTableOptions extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> FOREIGN_TABLE_CATALOG = createField(DSL.name("foreign_table_catalog"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.foreign_table_options.foreign_table_schema</code>.
     */
    public final TableField<Record, String> FOREIGN_TABLE_SCHEMA = createField(DSL.name("foreign_table_schema"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.foreign_table_options.foreign_table_name</code>.
     */
    public final TableField<Record, String> FOREIGN_TABLE_NAME = createField(DSL.name("foreign_table_name"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
    ...
    private ForeignTableOptions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private ForeignTableOptions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> ForeignTableOptions(Table<O> child, ForeignKey<O, Record> key) {
