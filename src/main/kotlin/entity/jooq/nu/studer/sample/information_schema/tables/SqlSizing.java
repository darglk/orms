...
public class SqlSizing extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> SIZING_ID = createField(DSL.name("sizing_id"), nu.studer.sample.information_schema.Domains.CARDINAL_NUMBER.getDataType(), this, "");

    /**
     * The column <code>information_schema.sql_sizing.sizing_name</code>.
     */
    public final TableField<Record, String> SIZING_NAME = createField(DSL.name("sizing_name"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");

    /**
     * The column <code>information_schema.sql_sizing.supported_value</code>.
     */
    public final TableField<Record, Integer> SUPPORTED_VALUE = createField(DSL.name("supported_value"), nu.studer.sample.information_schema.Domains.CARDINAL_NUMBER.getDataType(), this, "");
