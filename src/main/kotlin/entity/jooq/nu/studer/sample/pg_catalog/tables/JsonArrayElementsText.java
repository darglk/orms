...
public class JsonArrayElementsText extends TableImpl<Record> {
    ...
    private JsonArrayElementsText(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR)
        });
    }

    private JsonArrayElementsText(Name alias, Table<Record> aliased, Field<?>[] parameters) {
