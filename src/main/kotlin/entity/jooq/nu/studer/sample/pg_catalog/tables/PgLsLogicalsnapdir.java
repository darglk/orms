...
public class PgLsLogicalsnapdir extends TableImpl<Record> {
    ...
    private PgLsLogicalsnapdir(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgLsLogicalsnapdir(Name alias, Table<Record> aliased, Field<?>[] parameters) {
