...
public class JsonbEach extends TableImpl<Record> {
    ...
    private JsonbEach(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR)
        });
    }

    private JsonbEach(Name alias, Table<Record> aliased, Field<?>[] parameters) {
