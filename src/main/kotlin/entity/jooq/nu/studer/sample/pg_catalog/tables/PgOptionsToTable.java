...
public class PgOptionsToTable extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> OPTION_NAME = createField(DSL.name("option_name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_options_to_table.option_value</code>.
     */
    public final TableField<Record, String> OPTION_VALUE = createField(DSL.name("option_value"), SQLDataType.CLOB, this, "");

    private PgOptionsToTable(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.CLOB.array())
        });
    }

    private PgOptionsToTable(Name alias, Table<Record> aliased, Field<?>[] parameters) {
