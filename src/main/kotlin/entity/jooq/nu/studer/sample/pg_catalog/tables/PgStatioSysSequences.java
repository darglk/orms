...
public class PgStatioSysSequences extends TableImpl<Record> {
    ...
    private PgStatioSysSequences(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatioSysSequences(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatioSysSequences(Table<O> child, ForeignKey<O, Record> key) {
