...
public class PgPartitionAncestors extends TableImpl<Record> {
    ...
    private PgPartitionAncestors(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\""))
        });
    }

    private PgPartitionAncestors(Name alias, Table<Record> aliased, Field<?>[] parameters) {
