...
public class PgStatDatabase extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Double> SESSION_TIME = createField(DSL.name("session_time"), SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_database.active_time</code>.
     */
    public final TableField<Record, Double> ACTIVE_TIME = createField(DSL.name("active_time"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_stat_database.idle_in_transaction_time</code>.
     */
    public final TableField<Record, Double> IDLE_IN_TRANSACTION_TIME = createField(DSL.name("idle_in_transaction_time"), SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_database.sessions</code>.
     */
    public final TableField<Record, Long> SESSIONS = createField(DSL.name("sessions"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_database.sessions_abandoned</code>.
     */
    public final TableField<Record, Long> SESSIONS_ABANDONED = createField(DSL.name("sessions_abandoned"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_database.sessions_fatal</code>.
     */
    public final TableField<Record, Long> SESSIONS_FATAL = createField(DSL.name("sessions_fatal"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_database.sessions_killed</code>.
     */
    public final TableField<Record, Long> SESSIONS_KILLED = createField(DSL.name("sessions_killed"), SQLDataType.BIGINT, this, "");
