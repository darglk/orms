...
public class PgStatioUserIndexes extends TableImpl<Record> {
    ...
    private PgStatioUserIndexes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatioUserIndexes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatioUserIndexes(Table<O> child, ForeignKey<O, Record> key) {
