...
public class PgStatisticExtData extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Boolean> STXDINHERIT = createField(DSL.name("stxdinherit"), SQLDataType.BOOLEAN.nullable(false), this, "");
     ...
     */
    public final TableField<Record, Record[]> STXDEXPR = createField(DSL.name("stxdexpr"), nu.studer.sample.pg_catalog.tables.PgStatistic.PG_STATISTIC.getDataType().array(), this, "");
