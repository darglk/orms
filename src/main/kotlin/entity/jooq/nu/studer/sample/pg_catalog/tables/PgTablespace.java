...
public class PgTablespace extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String[]> SPCACL = createField(DSL.name("spcacl"), SQLDataType.VARCHAR.array(), this, "");

    /**
     * The column <code>pg_catalog.pg_tablespace.spcoptions</code>.
     */
    public final TableField<Record, String[]> SPCOPTIONS = createField(DSL.name("spcoptions"), SQLDataType.CLOB.array(), this, "");
