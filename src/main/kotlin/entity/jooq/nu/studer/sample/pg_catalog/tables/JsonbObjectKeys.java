...
public class JsonbObjectKeys extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> JSONB_OBJECT_KEYS_ = createField(DSL.name("jsonb_object_keys"), SQLDataType.CLOB, this, "");

    private JsonbObjectKeys(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR)
        });
    }

    private JsonbObjectKeys(Name alias, Table<Record> aliased, Field<?>[] parameters) {
