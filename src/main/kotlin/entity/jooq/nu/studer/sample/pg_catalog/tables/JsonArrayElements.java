...
public class JsonArrayElements extends TableImpl<Record> {
    ...
    private JsonArrayElements(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR)
        });
    }

    private JsonArrayElements(Name alias, Table<Record> aliased, Field<?>[] parameters) {
