...
public class TsStat extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> NENTRY = createField(DSL.name("nentry"), SQLDataType.INTEGER, this, "");

    private TsStat(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.CLOB)
        });
    }

    private TsStat(Name alias, Table<Record> aliased, Field<?>[] parameters) {
