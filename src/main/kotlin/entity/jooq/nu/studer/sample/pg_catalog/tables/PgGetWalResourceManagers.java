...
public class PgGetWalResourceManagers extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> RM_ID = createField(DSL.name("rm_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>pg_catalog.pg_get_wal_resource_managers.rm_name</code>.
     */
    public final TableField<Record, String> RM_NAME = createField(DSL.name("rm_name"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>pg_catalog.pg_get_wal_resource_managers.rm_builtin</code>.
     */
    public final TableField<Record, Boolean> RM_BUILTIN = createField(DSL.name("rm_builtin"), SQLDataType.BOOLEAN, this, "");

    private PgGetWalResourceManagers(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgGetWalResourceManagers(Name alias, Table<Record> aliased, Field<?>[] parameters) {
