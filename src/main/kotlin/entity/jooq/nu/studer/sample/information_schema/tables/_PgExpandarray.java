...
public class _PgExpandarray extends TableImpl<Record> {
     ...
     */
    @Deprecated
    public final TableField<Record, Object> X = createField(DSL.name("x"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"anyelement\""), this, "");

    /**
     * The column <code>information_schema._pg_expandarray.n</code>.
     */
    public final TableField<Record, Integer> N = createField(DSL.name("n"), SQLDataType.INTEGER, this, "");

    private _PgExpandarray(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.OTHER.array())
        });
    }

    private _PgExpandarray(Name alias, Table<Record> aliased, Field<?>[] parameters) {
