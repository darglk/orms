...
public class Attributes extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> ATTRIBUTE_NAME = createField(DSL.name("attribute_name"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
     ...
     */
    public final TableField<Record, String> ATTRIBUTE_DEFAULT = createField(DSL.name("attribute_default"), nu.studer.sample.information_schema.Domains.CHARACTER_DATA.getDataType(), this, "");
     ...
     */
    public final TableField<Record, String> ATTRIBUTE_UDT_CATALOG = createField(DSL.name("attribute_udt_catalog"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column
     * <code>information_schema.attributes.attribute_udt_schema</code>.
     */
    public final TableField<Record, String> ATTRIBUTE_UDT_SCHEMA = createField(DSL.name("attribute_udt_schema"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");

    /**
     * The column <code>information_schema.attributes.attribute_udt_name</code>.
     */
    public final TableField<Record, String> ATTRIBUTE_UDT_NAME = createField(DSL.name("attribute_udt_name"), nu.studer.sample.information_schema.Domains.SQL_IDENTIFIER.getDataType(), this, "");
     ...
     */
    public final TableField<Record, String> IS_DERIVED_REFERENCE_ATTRIBUTE = createField(DSL.name("is_derived_reference_attribute"), nu.studer.sample.information_schema.Domains.YES_OR_NO.getDataType(), this, "");
