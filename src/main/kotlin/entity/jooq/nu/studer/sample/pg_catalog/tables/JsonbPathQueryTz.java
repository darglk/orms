...
public class JsonbPathQueryTz extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> JSONB_PATH_QUERY_TZ_ = createField(DSL.name("jsonb_path_query_tz"), SQLDataType.VARCHAR, this, "");

    private JsonbPathQueryTz(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.VARCHAR),
            DSL.val(null, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"jsonpath\"")),
            DSL.val(null, SQLDataType.VARCHAR.defaultValue(DSL.field(DSL.raw("'{}'::jsonb"), SQLDataType.VARCHAR))),
            DSL.val(null, SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)))
        });
    }

    private JsonbPathQueryTz(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public JsonbPathQueryTz call(
        ...
        JsonbPathQueryTz result = new JsonbPathQueryTz(DSL.name("jsonb_path_query_tz"), null, new Field[] {
            ...
            DSL.val(vars, SQLDataType.VARCHAR.defaultValue(DSL.field(DSL.raw("'{}'::jsonb"), SQLDataType.VARCHAR))),
