...
public class PgPreparedStatement extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Object[]> PARAMETER_TYPES = createField(DSL.name("parameter_types"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regtype\"").array(), this, "");

    /**
     * The column <code>pg_catalog.pg_prepared_statement.result_types</code>.
     */
    public final TableField<Record, Object[]> RESULT_TYPES = createField(DSL.name("result_types"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regtype\"").array(), this, "");
     ...
     */
    public final TableField<Record, Long> GENERIC_PLANS = createField(DSL.name("generic_plans"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_prepared_statement.custom_plans</code>.
     */
    public final TableField<Record, Long> CUSTOM_PLANS = createField(DSL.name("custom_plans"), SQLDataType.BIGINT, this, "");

    private PgPreparedStatement(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgPreparedStatement(Name alias, Table<Record> aliased, Field<?>[] parameters) {
