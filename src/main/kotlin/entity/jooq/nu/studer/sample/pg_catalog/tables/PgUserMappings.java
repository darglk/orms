...
public class PgUserMappings extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> UMID = createField(DSL.name("umid"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_user_mappings.srvid</code>.
     */
    public final TableField<Record, Long> SRVID = createField(DSL.name("srvid"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_user_mappings.srvname</code>.
     */
    public final TableField<Record, String> SRVNAME = createField(DSL.name("srvname"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_user_mappings.umuser</code>.
     */
    public final TableField<Record, Long> UMUSER = createField(DSL.name("umuser"), SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<Record, String[]> UMOPTIONS = createField(DSL.name("umoptions"), SQLDataType.CLOB.array(), this, "");

    private PgUserMappings(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgUserMappings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgUserMappings(Table<O> child, ForeignKey<O, Record> key) {
