...
public class GenerateSubscripts extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> GENERATE_SUBSCRIPTS_ = createField(DSL.name("generate_subscripts"), SQLDataType.INTEGER, this, "");

    private GenerateSubscripts(Name alias, Table<Record> aliased) {
    ...
    private GenerateSubscripts(Name alias, Table<Record> aliased, Field<?>[] parameters) {
