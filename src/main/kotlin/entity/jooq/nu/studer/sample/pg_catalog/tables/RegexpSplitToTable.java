...
public class RegexpSplitToTable extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> REGEXP_SPLIT_TO_TABLE_ = createField(DSL.name("regexp_split_to_table"), SQLDataType.CLOB, this, "");

    private RegexpSplitToTable(Name alias, Table<Record> aliased) {
    ...
    private RegexpSplitToTable(Name alias, Table<Record> aliased, Field<?>[] parameters) {
