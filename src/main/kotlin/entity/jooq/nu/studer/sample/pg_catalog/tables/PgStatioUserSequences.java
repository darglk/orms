...
public class PgStatioUserSequences extends TableImpl<Record> {
    ...
    private PgStatioUserSequences(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatioUserSequences(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatioUserSequences(Table<O> child, ForeignKey<O, Record> key) {
