...
public class PgGetKeywords extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> CATCODE = createField(DSL.name("catcode"), SQLDataType.CHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_get_keywords.barelabel</code>.
     */
    public final TableField<Record, Boolean> BARELABEL = createField(DSL.name("barelabel"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>pg_catalog.pg_get_keywords.catdesc</code>.
     */
    public final TableField<Record, String> CATDESC = createField(DSL.name("catdesc"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_get_keywords.baredesc</code>.
     */
    public final TableField<Record, String> BAREDESC = createField(DSL.name("baredesc"), SQLDataType.CLOB, this, "");

    private PgGetKeywords(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgGetKeywords(Name alias, Table<Record> aliased, Field<?>[] parameters) {
