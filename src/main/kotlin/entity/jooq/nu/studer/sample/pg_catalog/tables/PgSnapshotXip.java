...
public class PgSnapshotXip extends TableImpl<Record> {
     ...
     */
    @Deprecated
    public final TableField<Record, Object> PG_SNAPSHOT_XIP_ = createField(DSL.name("pg_snapshot_xip"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"xid8\""), this, "");

    private PgSnapshotXip(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_snapshot\""))
        });
    }

    private PgSnapshotXip(Name alias, Table<Record> aliased, Field<?>[] parameters) {
