...
public class PgShowAllSettings extends TableImpl<Record> {
    ...
    private PgShowAllSettings(Name alias, Table<Record> aliased) {
        this(alias, aliased, new Field[] {
        });
    }

    private PgShowAllSettings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
