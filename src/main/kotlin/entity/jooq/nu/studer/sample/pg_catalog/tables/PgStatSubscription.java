...
public class PgStatSubscription extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> SUBID = createField(DSL.name("subid"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_subscription.subname</code>.
     */
    public final TableField<Record, String> SUBNAME = createField(DSL.name("subname"), SQLDataType.VARCHAR, this, "");
     ...
     */
    @Deprecated
    public final TableField<Record, Object> RECEIVED_LSN = createField(DSL.name("received_lsn"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\""), this, "");
    ...
    private PgStatSubscription(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSubscription(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatSubscription(Table<O> child, ForeignKey<O, Record> key) {
