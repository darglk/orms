...
public class PgShmemAllocations extends TableImpl<Record> {
    ...
    private PgShmemAllocations(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgShmemAllocations(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgShmemAllocations(Table<O> child, ForeignKey<O, Record> key) {
