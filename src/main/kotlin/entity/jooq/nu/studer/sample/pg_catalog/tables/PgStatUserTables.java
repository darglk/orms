...
public class PgStatUserTables extends TableImpl<Record> {
    ...
    private PgStatUserTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PgStatUserTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PgStatUserTables(Table<O> child, ForeignKey<O, Record> key) {
